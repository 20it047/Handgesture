...
class face_rg:
    def __init__(self,root):
        ...
        # flbl.place(x=500,y=0,width=500,height=180)
        ...
        # img_lft = Image.open(r"D:\Face_Recognisation_system\Projec Images\students.jpg")
        # img_lft=img_lft.resize((700,130),Image.ANTIALIAS)
        # self.photoimglft=ImageTk.PhotoImage(img_lft)
        ...
        dep_label = Button(Current_course,command = runNow,text="Using hand\nRecognisation",font=("times new roman",20,"bold"))
        dep_label.grid(row=2,column=0,pady=5,sticky=W)

        # dep_label = Button(Current_course,text="Recognisation",font=("times new roman",20,"bold"))
        # dep_label.grid(row=3,column=0,pady=5,sticky=W)
        ...
        dep_label = Label(Current_course,text="Using Facial",font=("times new roman",20,"bold"))
        dep_label.grid(row=2,column=0,pady=5,sticky=W)

        dep_label = Label(Current_course,text="Movements",font=("times new roman",20,"bold"))
        dep_label.grid(row=3,column=0,pady=5,sticky=W)
        ...
        # flbl=Label(center_frame,bg="red")
        # flbl.place(x=0,y=0,width=700,height=250)
        save_btn = Button(center_frame,text="Start Mouse",width=66,font=("times new roman",12,"bold"),bg="Red",fg="black")
